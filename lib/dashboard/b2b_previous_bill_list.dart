...
class B2BPreviousBillList extends StatefulWidget {
  List<dynamic>? IPD;

  B2BPreviousBillList({super.key, this.IPD});

  @override
  B2BPreviousBillListState createState() => B2BPreviousBillListState();
}

class B2BPreviousBillListState extends State<B2BPreviousBillList> {
  List<dynamic>? IPD;
  bool load = false;
  ...
  void initState() {
    setState(() {
      widget.IPD?.length == 0 || widget.IPD == null
          ? load = true
          : load = false;
    });
